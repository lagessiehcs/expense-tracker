...
void update_terminal(int screen_id ,int user_id, int group_id,
    ...
    }else if (screen_id == 2){ // Login screen
        std::cout << "\n############################################\n";        
    ...
    }else if (screen_id == 3){ // Create User screen
        std::cout << "\n############################################\n";
        std::cout << "Enter your user name!\n";
        std::cout << "############################################\n";
    
    }else if (screen_id == 4){ // User screen
        std::cout << "\n############################################\n";
    ...
    }else if (screen_id == 5){ // Join group screen
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";    
    ...
    }else if (screen_id == 6){ // Create group          
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";
        std::cout << "Enter the group name!\n";
        std::cout << "############################################\n";
    
    }else if (screen_id == 7){ // group screen
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";
    ...
    }else if (screen_id == 8){ // Add expense
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";
        std::cout << "You are in group: "<< group_list[group_id].name() << ".\n";
    ...
    }else if (screen_id == 9){ // Check expences
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";
        std::cout << "You are in group: "<< group_list[group_id].name() << ".\n";
    ...
    }else if (screen_id == 10){ // User groups
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n"; 
    ...
    }else if (screen_id == 11){ // Create Settlement
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";    
    ...
    }else if (screen_id == 12){ // Leave group
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n"; 
    ...
    }else if (screen_id == 13){ // Edit Expense
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";   
        std::cout << "You are in group: "<< group_list[group_id].name() << ".\n";
    ...
    }else if (screen_id == 14){ // Group members
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";   
        std::cout << "You are in group: "<< group_list[group_id].name() << ".\n";
    ...
    }else if (screen_id == 15){ // See my balance
        std::cout << "\n############################################\n";
        std::cout << "Hello "<< user_list[user_id].name() << "!\n";   
        std::cout << "You are in group: "<< group_list[group_id].name() << ".\n";
